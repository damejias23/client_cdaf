...
type CdafEventMode struct {
	Trigger CdafEventTriggerAnyOf `json:"trigger"`
...
func NewCdafEventMode(trigger CdafEventTriggerAnyOf) *CdafEventMode {
	this := CdafEventMode{}
...
func (o *CdafEventMode) GetTrigger() CdafEventTriggerAnyOf {
	if o == nil {
		var ret CdafEventTriggerAnyOf
		return ret
	}
...
func (o *CdafEventMode) GetTriggerOk() (*CdafEventTriggerAnyOf, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CdafEventMode) SetTrigger(v CdafEventTriggerAnyOf) {
	o.Trigger = v
}
...
func (o CdafEventMode) MarshalJSON() ([]byte, error) {
...
type NullableCdafEventMode struct {
	value *CdafEventMode
	isSet bool
}

func (v NullableCdafEventMode) Get() *CdafEventMode {
	return v.value
}

func (v *NullableCdafEventMode) Set(val *CdafEventMode) {
	v.value = val
	v.isSet = true
}

func (v NullableCdafEventMode) IsSet() bool {
	return v.isSet
}

func (v *NullableCdafEventMode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdafEventMode(val *CdafEventMode) *NullableCdafEventMode {
	return &NullableCdafEventMode{value: val, isSet: true}
}

func (v NullableCdafEventMode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCdafEventMode) UnmarshalJSON(src []byte) error {
	v.isSet = true
